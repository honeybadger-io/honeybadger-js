...
// Generated by CoffeeScript 1.7.1
var Honeybadger, UncaughtError, currentError, currentNotice, _ref,
...
Honeybadger = {
  ...
  notify: function(error, options) {
    var handler, k, n, notice, v, _i, _len, _ref1, _ref2, _ref3;
    if (options == null) {
      options = {};
    }
    ...
    _ref2 = this.beforeNotifyHandlers;
    ...
    _ref3 = [options.error, notice], currentError = _ref3[0], currentNotice = _ref3[1];
    return window.setTimeout((function(_this) {
      return function() {
        var _ref4;
        if (options.error === currentError) {
          _ref4 = [null, null], currentError = _ref4[0], currentNotice = _ref4[1];
          return _this._sendRequest(notice.toJSON());
        }
      };
    })(this));
  },
