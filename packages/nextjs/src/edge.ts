...
//
// This is why the `edge-light` exports condition has to stay: without it Next resolves
// this package to the browser bundle in that context, and the build fails with
// "Export captureRequestError doesn't exist".
//
